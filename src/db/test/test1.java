...
public class test1 extends TestCase {
    ...
    private void doRun1() throws Throwable {
        ...
        // final Timestamp ts1 = Timestamp.valueOf("1970-01-01 00:00:01"); // ? mysql
        // cannot be committed
        // u4.setBirthTime(ts1);
        ...
        // u4.setFlt(3.402823466E+38f); // ? mysql max is 3.402823466E+38 but it does
        // not work
        ...
        // u8.createGame();
        // u8.createGame();
        // tn.delete(u8); // d1, g1, g2 gets deleted with "delete from" instead of get
        // delete because they
        // // don't not aggregate
        //
        ...
        //
        // // ! on unix only
        // final int procres = Runtime.getRuntime().exec("diff
        // qa/files/far_side_dog_ok.jpg qa/dog_ok.jpg").waitFor();
        // if (procres != 0)
        // throw new RuntimeException();
