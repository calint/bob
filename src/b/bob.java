...
public class bob extends websock{
	...
	@Override final protected void on_opened()throws Throwable{
//		System.out.println("websocket "+Integer.toHexString(hashCode())+": on_opened");
	...
	@Override final protected void on_message(final ByteBuffer bb)throws Throwable{
		...
		try{
			...
			try{
				...
				x.closeUpdateIfOpen();
				x.xalert("method not found:\npublic x_"+target_elem_method+"(xwriter,String) in "+target_elem.getClass().getName()+" or it's super classes.");
			}
			x.finish();
	...
	@Override final protected void on_closed()throws Throwable{
