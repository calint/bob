...
//	}
	...
	/**
	 * Replaces an element by setting the field of the element_to_replace with this.
	 * 
	 * @param new_parent         the new parent of this element.
	 * @param element_to_replace the element to replace which must be a public
	 *                           field.
	 */
	public void replace(a new_parent, a element_to_replace) {
		this.parent = new_parent;
		this.name = element_to_replace.name;
		try {
