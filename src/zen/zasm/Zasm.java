...
public final class Zasm {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        String output = tc.toAnnotatedHexString(padTo64K);
        // false: don't pad to 64K
    ...
    private Toc compile(String srcIn, boolean padTo64K) throws Throwable {
        stmts.clear();
        ...
        if (!src.toString().equals(srcIn)) {
            ...
            throw new Exception("reproduced source from statements differs from the source");
        }
